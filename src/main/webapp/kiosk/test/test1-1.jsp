...
<div class="container">
	 ...
	 <div class="main color2" align="center">	
	 	<div class="page w3-button"onclick="jumoon0()" ><h2>디 저 트</h2></div>
	 	<div class="page w3-button"onclick="jumoon1()" ><h2>음 료 수</h2></div>
	</div>
...
<div class="jumoon color1" align="center">
		...
		<div class="qqq" onclick="close()" ><h1>취소하기</h1></div>
