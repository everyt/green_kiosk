...
<div class="w3-top">
  <div class="w3-white w3-xlarge" style="max-width:1000px;margin:auto">
      <div class="w3-right w3-button w3-padding-16 w3-left" onclick="moveWhite1()">장바구니 보기</div>
  </div>
</div>
 ...
 <div class="w3-container w3-quarter">
  ...
  <a href="page4.jsp" class="w3-bar-item w3-button w3-xlarge w3-hover-black">음료수</a>
   ...
   <div class="w3-row-padding w3-padding-16 w3-center w3-tooltip" id="food">
	  ...
	  <p>쇠고기패티에 달콤 짭짤한 데리소스를 더한 가성비 버거</p>
	    ...
	    <button class="w3-button w3-xlarge w3-circle " id="plus"
  				    onclick='count("minus")'>-</button>
				<button class="w3-xlarge   " id='result'>0</button>
  		<button class="w3-button w3-xlarge w3-circle  " id="minus"
    	 			onclick='count("plus")'>+</button>
 				<div>
  		<button class="w3-button w3-xlarge w3-circle" id="cart"
    	 			onclick="putCart(this.form)">장바구니 담기</button>   			
    	 	</div>
  ...
  <div class="w3-row-padding w3-padding-16 w3-center">
	...
	<div class="w3-quarter w3-container">
      ...
      <div class="w3-quarter w3-container w3-right w3-button w3-padding-16 w3-left" onclick="moveWhite1()">결제하기</div>
	</div>
</div>
