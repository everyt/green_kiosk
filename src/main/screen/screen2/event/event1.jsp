...
<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
  ...
  <div id="demoAcc1" class="w3-bar-block w3-hide w3-white w3-card-4">
    <a href="event1.jsp" class="w3-bar-item w3-button">이벤트</a>
    <a href="event1.jsp" class="w3-bar-item w3-button">쿠폰</a>
...
<div class="w3-row-padding w3-margin-top">
  <div class="w3-third">
    <div class="w3-card">
      <img src="../images/event1.jpg" width="300" height="300" style="width:100%">
  ...
  <div class="w3-third">
    <div class="w3-card">
      <img src="../images/event2.jpg" width="300" height="300" style="width:100%">
      <div class="w3-container">
        <h5>Monterosso</h5>
      </div>
    </div>
